...
static const std::map<uint16_t, std::string> JEP106_MAP
{
    {0x001, "AMD"}, 
    {0x002, "AMI"}, 
    {0x003, "Fairchild"}, 
    ...
    {0x3d1, "GigaDevice Semiconductor (Beijing) Inc."}, 
    ...
    {0x3e9, "High Bridge Solutions Industria Eletronica"}, 
    ...
    {0x419, "Phytium"}, 
    {0x41a, "Xi?an UnilC Semiconductors Co., Ltd."}, 
    {0x41b, "Ambiq Micro"}, 
    ...
    {0x495, "Silicon Mobility"}, 
    {0x496, "IQ-Analog Corporation"}, 
    {0x497, "Uhnder, Inc."}, 
    {0x498, "Impinj"}, 
    {0x499, "DEPO Computers"}, 
    {0x49a, "Nespeed Sysems"}, 
    {0x49b, "Yangtze Memory Technologies Co. Ltd"}, 
    {0x49c, "MemxPro Inc."}, 
    {0x49d, "Tammuz Co., Ltd."}, 
    {0x49e, "Allwinner Technology"}, 
    {0x49f, "Shenzhen City Futian District Qing Xuan Tong Computer Trading Firm"}, 
    {0x4a0, "XMC"}, 
    {0x4a1, "Teclast"}, 
    {0x4a2, "Maxsun"}, 
    {0x4a3, "Haiguang Integrated Circuit Design"}, 
    {0x4a4, "RamCENTER Technology"}, 
    {0x4a5, "Phison Electronics Corporation"}, 
    {0x4a6, "Guizhou Huaxintong Semi-Conductor"}, 
    {0x4a7, "Network Intelligence"}, 
    {0x4a8, "Continental Technology (Holdings)"}, 
    {0x4a9, "Guangzhou Huayan Suning Electronic"}, 
    {0x4aa, "Guangzhou Zhouji Electronic Co., Ltd."}, 
    {0x4ab, "Shenzhen Giant Hui Kang Tech Co. Ltd"}, 
    {0x4ac, "Shenzhen Yilong Innovative Co. Ltd."}, 
    {0x4ad, "Neo Forza"}, 
    {0x4ae, "Lyontek Inc."}, 
    {0x4af, "Shanghai Kuxin Microelectronics Ltd."}, 
    {0x4b0, "Shenzhen Larix Technology Co. Ltd."}, 
    {0x4b1, "Qbit Semiconductor Ltd."}, 
    {0x4b2, "Insignis Technology Corporation"}, 
    {0x4b3, "Lanson Memory Co. Ltd."}, 
    {0x4b4, "Shenzhen Superway Electronics Co Ltd"}, 
    {0x4b5, "Canaan-Creative Co. Ltd."}, 
    {0x4b6, "Black Diamond Memory"}, 
    {0x4b7, "Shenzhen City Parker Baking Electronics"}, 
    {0x4b8, "Shenzhen Baihong Technology Co. Ltd."}, 
    {0x4b9, "GEO Semiconductors"}, 
    {0x4ba, "DTG NEO Scientific Ltd."}, 
    {0x4bb, "Artery Technology Co. Ltd."}, 
    {0x4bc, "Jinyu"}, 
    {0x4bd, "ShenzhenYing Chi Technology Development"}, 
    {0x4be, "Shenzhen Pengcheng Xin Technology"}, 
    {0x4bf, "Pegasus Semiconductor (Shanghai) Co."}, 
    {0x4c0, "Mythic, Inc."}, 
    {0x4c1, "Elmos Semiconductor AG"}, 
    {0x4c2, "Kllisre"}, 
    {0x4c3, "Shenzhen Yuan Chuang Wei Tech"}, 
    {0x4c4, "Shenzhen Xingmem Technology Corp."}, 
};
#else
static const std::map<uint16_t, std::string> JEP106_MAP;
#endif

std::string DeviceDB::vendorName(uint16_t jtagID)
{
    auto it = JEP106_MAP.find(jtagID);
    if (it != JEP106_MAP.end())
        return (*it).second;
    else
        return std::string();
}
